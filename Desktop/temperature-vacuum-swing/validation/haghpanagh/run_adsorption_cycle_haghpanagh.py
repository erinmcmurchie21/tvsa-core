...
from additional_functions_haghpanagh import create_non_uniform_grid, adsorption_isotherm_1, adsorption_isotherm_2, total_mass_balance_error, CO2_mass_balance_error, energy_balance_error, create_plot, create_combined_plot
from scipy import integrate
import time
import matplotlib.pyplot as plt
import tvsa_adsorption_column_haghpanagh as column
...
def create_fixed_properties():
    ...
    "bed_length": 1.0,  # Example value for bed length in meters
    "inner_bed_radius": 0.1445,
    "outer_bed_radius": 0.162,  # Example value for bed diameter in meters
    ...
    "particle_voidage": 0.35,  # Example value for particle voidage
...
def define_boundary_conditions(bed_properties):
    inlet_values = {
        ...
        "velocity": 1.0,  # Example value for interstitial velocity in m/s
