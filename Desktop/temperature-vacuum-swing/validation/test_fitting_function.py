...
# Import your modules
try:
    from additional_functions_validation import create_non_uniform_grid, adsorption_isotherm_1, adsorption_isotherm_2
    import tvsa_adsorption_column_validation as column
    import run_adsorption_cycle_validation as run
    print("✓ All modules imported successfully")
except ImportError as e:
    print(f"✗ Import error: {e}")
    print("Make sure all your Python files are in the current directory or adjust the sys.path.append() line")
    sys.exit(1)
...
def load_experimental_data():
    ...
    try:
        ...
        t_observed_temperature = np.loadtxt('C:\\Users\\ejm21\\Desktop\\temperature-vacuum-swing\\validation\\pini_data_temperature.csv', delimiter=',', usecols=0)
        temperature_observed = np.loadtxt('C:\\Users\\ejm21\\Desktop\\temperature-vacuum-swing\\validation\\pini_data_temperature.csv', delimiter=',', usecols=1)
        t_observed_molefraction = np.loadtxt('C:\\Users\\ejm21\\Desktop\\temperature-vacuum-swing\\validation\\pini_data_molefraction.csv', delimiter=',', usecols=0)
        molefraction_observed = np.loadtxt('C:\\Users\\ejm21\\Desktop\\temperature-vacuum-swing\\validation\\pini_data_molefraction.csv', delimiter=',', usecols=1)
