...
from tvsa_adsorption_column_clean import ODE_calculations
...
inlet_values = {
    ...
    "mu": 1.78e-5,  # Example value for feed viscosity in Pa.s
    "y1_feed_value": 0.0004,  # Example value for feed mole fraction
...
#create_plot(time, n2_result, "H2O loading against time", "Loading H
