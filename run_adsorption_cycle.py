...
from additional_functions_clean import create_non_uniform_grid, adsorption_isotherm_1, adsorption_isotherm_2, total_mass_balance_error, CO2_mass_balance_error, energy_balance_error, create_plot
...
inlet_values = {
    ...
    "feed_mass_flow": (0.1 * float(bed_properties_stampi_bombelli_analysis["column_area"]) * 1.13),  # Example value for feed mass flow in kg/s
...
def ODE_func(t, results_vector):
    return ODE_calculations(t, results_vector=results_vector, column_grid=column_grid, bed_properties=bed_properties_stampi_bombelli_analysis, inlet_values=inlet_values, outlet_values=outlet_values)
...
print("Mass balance error:", total_mass_balance_error(F_result, P_result, T_result, n1_result, n2_result, time, bed_properties_stampi_bombelli_analysis, column_grid))
print("CO2 mass balance error:", CO2_mass_balance_error(F_result, P_result, T_result, y1_result, n1_result, time, bed_properties_stampi_bombelli_analysis, column_grid))
print("Energy balance error:", energy_balance_error(E_result, T_result, P_result, y1_result, y2_result, n1_result, n2_result, time, bed_properties_stampi_bombelli_analysis, column_grid))

# Create a combined plot with all 6 variables
def create_combined_plot(time, T_result, P_result, y1_result, n1_result, y2_result, n2_result):
    ...
    plot_data = [
        ...
        (y2_result, "Gas phase H2O against time", "Gas Phase H2O (mol fraction)", axes[1, 1]),
...
create_combined_plot(time, T_result, P_result, y1_result, n1_result, y2_result, n2_result)
