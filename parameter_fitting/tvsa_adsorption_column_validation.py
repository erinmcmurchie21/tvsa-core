...
def calculate_internal_wall_values(
    ...
    dTdz_walls[0] = -(v_left * Pe_h) * (
        left_values["feed_temperature"] - T_left
    )  # set left temperature gradient
